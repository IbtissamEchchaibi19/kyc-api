...
# from . import bcrypt, mongo  # Import mongo here
...
# # def handle_upload_image(username, file):
# #     if file:
# #         # Prepare image data
# #         image_data = {
# #             "filename": file.filename,  # Temporary filename
# #             "content_type": file.content_type,
# #             "data": file.read()
# #         }
        
# #         # Update images in the database
# #         result = update_user_images(username, image_data)
        
# #         if "success" in result:
# #             # Fetch the updated document
# #             user_images = mongo.db.images.find_one({"username": username})
# #             if user_images and "images" in user_images:
# #                 # Rename images based on their position
# #                 images = user_images["images"]
                
# #                 for index, img in enumerate(images):
# #                     if index == 0:
# #                         new_filename = "screenshot"
# #                     elif index == 1:
# #                         new_filename = "selfie"
# #                     elif index == 2:
# #                         new_filename = "imagecard"
# #                     else:
...
# #                         {"$set": {"images.$.filename": new_filename}}
# #                     )
                
# #                 # Fetch the latest image for response
# #                 latest_image = images[-1]
# #                 return {"message": "Image uploaded successfully", "file_id": latest_image["_id"]}, 201
# #             else:
# #                 return {"error": "Failed to retrieve image ID"}, 500
# #         else:
